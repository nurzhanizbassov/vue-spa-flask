...
export default {
  ...
  data() {
    console.log('EditGame. gameToEdit: ', this.$props.gameToEdit);
    console.log('EditGame. gameToEdit.game_type: ', this.$props.gameToEdit.game_type);
    return {
      ...
      gameType: this.$props.gameToEdit.game_type.id,
